...
تطبيق أندرويد **Native** (Kotlin + Jetpack Compose + Room) — تصميم
"Reimagined 2026": **البرج هو الواجهة** — مسقط واحد بعدسات (Lenses) بتعيد
تلوينه بدل أدوات منفصلة، برج حي على الجنب بيبدّل الـ48 دور بسحبة إبهام،
Command bar للبحث، وSheet واعي بالعدسة. **كل دور معزول تماماً** عن غيره
(عدّ، كومنتات، ملفات، مرفقات). العدسات:
