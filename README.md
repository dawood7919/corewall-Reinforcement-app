...
تطبيق أندرويد **Native** (Kotlin + Jetpack Compose + Room) بيشتغل على مبدأ
**"دور شغّال واحد"**: هيدر كبير ثابت فوق بيوضّح الدور اللي شغّال عليه، و**كل
حاجة في التطبيق بتخص الدور ده بس** — عدّ، كومنتات، حالات فحص، ملفات، مرفقات،
مهام، وتعليقات PDF. تبدّل الدور من الهيدر = التطبيق يبان فاضي (دور جديد)،
وترجع لدور فات تلاقي كل اللي عملته فيه زي ما هو. الجدول المكتبي (تصميم الدور
من الرسمة) هو الوحيد اللي بيفضل ظاهر لأنه مش بياناتك إنت.

نفس المسقط بيتشاف بـ**عدسات** (Lenses) بتعيد تلوينه من غير ما تفقد الدور:
...
3. **Data** — ملفات وبيانات كل دور: "بلان فيل" (كومنتات ومرفقات لكل جدار في
   الدور المختار)، "الملفات" (مدير ملفات لكل دور: مجلدات، رفع، فتح/مشاركة/حذف —
   شوب دروينج، BBS، دليفري نوت، أوتوكاد، صور…)، و"المهام" (To-Do بأولويات
   وتواريخ استحقاق وربط بالأدوار). ومعاها **عارض PDF داخلي** بأدوات تعليق
   (هايلايت، مستطيل، دايرة، سهم، رسم حر) بتتحفظ تلقائي مع إمكانية تصدير
   نسخة معلّقة.
