...
تطبيق أندرويد **Native** (Kotlin + Jetpack Compose + Room) لمتابعة تسليح الكور وول
دور بدور: مسقط تفاعلي، جداول مدايات التسليح (31 حائط + 49 كمرة على 48 دور)،
حالات فحص، كومنتات، وتصدير PDF/PNG — كل البيانات بتتحفظ تلقائي محليًا.
