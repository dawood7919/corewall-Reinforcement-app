...
dependencies {
    ...
    //
    // ليه LiteRT-LM مش MediaPipe: واجهة MediaPipe للـLLM بقت في وضع
    // الصيانة بس، وجوجل نفسها بتقول انقل لـLiteRT-LM. البناء على حاجة
    // متوقّفة من أول يوم مالوش معنى.
    //
    // النسخة مثبّتة مش `latest.release` اللي التوثيق بيقترحه — عن قصد:
    // المشروع على Kotlin 2.0.21، وأي مكتبة متبنية على كومبايلر أحدث
    // ميتاداتاها مابتتقريش وبيقع البناء. ده بالظبط اللي حصل مع PDFium
    // ومكتوب فوق. الترقية قرار لوحده، مش حاجة تحصل من نفسها.
