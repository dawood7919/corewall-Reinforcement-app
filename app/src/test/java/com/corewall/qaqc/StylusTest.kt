 ...
 *
 * آلة حالات اللمس نفسها بتاخد `MotionEvent`، وده كائن أندرويد ماينفعش
 * يتعمل في اختبار وحدة على الـJVM — الجزء ده محتاج اختبار على جهاز.
 * اللي هنا هو التصنيف وحساب الضغط، ودول اللي أي غلط فيهم بيغيّر السلوك
 * من غير ما يفشل البناء.
 */
class StylusTest {
